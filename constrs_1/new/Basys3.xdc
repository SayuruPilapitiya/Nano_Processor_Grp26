# ==========================================
# Nanoprocessor Basys 3 Master Constraints
# ==========================================

# 1. Clock signal (100 MHz oscillator on the board)
set_property PACKAGE_PIN W5 [get_ports Clk]
set_property IOSTANDARD LVCMOS33 [get_ports Clk]

# 2. Reset Button (Center Pushbutton)
...
# Register 7 Output (Mapped to the first 4 LEDs: LD0 to LD3)
...
set_property PACKAGE_PIN W3 [get_ports Zero_Flag]
set_property IOSTANDARD LVCMOS33 [get_ports Zero_Flag]

set_property PACKAGE_PIN U3 [get_ports Not_Zero_Flag]
set_property IOSTANDARD LVCMOS33 [get_ports Not_Zero_Flag]

set_property PACKAGE_PIN P3 [get_ports Overflow_Flag]
set_property IOSTANDARD LVCMOS33 [get_ports Overflow_Flag]


set_property PACKAGE_PIN N3 [get_ports Equal_Flag]
set_property IOSTANDARD LVCMOS33 [get_ports Equal_Flag]

set_property PACKAGE_PIN P1 [get_ports Greater_Flag]
set_property IOSTANDARD LVCMOS33 [get_ports Greater_Flag]

# Overflow Flag (Mapped to LD15)
set_property PACKAGE_PIN L1 [get_ports Less_Flag]
set_property IOSTANDARD LVCMOS33 [get_ports Less_Flag]

# ==========================================
# 7-Segment Display Constraints
# ==========================================

# 7-Segment Segments (g, f, e, d, c, b, a)
